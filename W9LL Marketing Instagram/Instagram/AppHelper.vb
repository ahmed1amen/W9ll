...
Public Class AppHelper
    ...
    Public Shared Property UserDataTable_Control() As DataTable
        ...
        Set(value As DataTable)
            Dim path As String
            If InstgramClient.SFD_Accounts.ShowDialog = DialogResult.OK Then
                path = InstgramClient.SFD_Accounts.FileName
        ...
        Get
            Try
                ...
                If InstgramClient.OFD_Accounts.ShowDialog = DialogResult.OK Then
                    path = InstgramClient.OFD_Accounts.FileName
