...
Namespace My
    ...
    Partial Friend Class MyApplication
        Protected Overrides Function OnStartup(ByVal eventArgs As Microsoft.VisualBasic.ApplicationServices.StartupEventArgs) As Boolean
            Xpcom.Initialize(Path.Combine(My.Application.Info.DirectoryPath, "xulrunner\"))
            Return True
        End Function
        Private Sub MyApplication_UnhandledException(sender As Object,
            ...
            Dim myFilePath As String = Path.Combine(My.Application.Info.DirectoryPath, "TwitterError.log")
